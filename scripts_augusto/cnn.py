...
tempofiltnorm2 = time.time()
tempofiltnorm = tempofiltnorm2 - tempofiltnorm1
...
model.load_weights("modelo_CNN.h5")
tempocria2 = time.time()
tempocria = tempocria2 - tempocria1
#Aplicar a classificação da batida através do modelo carregado
tempopred1 = time.time()
predic = model.predict([base_MLII])
tempopred2 = time.time()
tempopred = tempopred2 - tempopred1

#Transformar a predição em um vetor de saída
#Identificando batida através de predição
tempodetrad1 = time.time()
vetor_final_predic = tpSig_predc(predic)
tempodetrad2 = time.time()
tempodetrad = tempodetrad2 - tempodetrad1
tempototal2 = time.time()
tempototal = tempototal2 - tempototal1

print(vetor_final_predic)

print("Tempo de importação: ", tempoimport) #Tempo para importar o sinal
print("Tempo de normalização: ", tempofiltnorm) #Tempo para filtragem e normalização
print("Tempo de segmentação: ", temposegm) #Tempo para segmentação
print("Tempo de criação do modelo: ", tempocria) #Tempo para criação do modelo
print("Tempo de predição: ", tempopred) #Tempo para predição
print("Tempo de tradução: ", tempodetrad) #Tempo para tradução da predição
print("Tempo total: ", tempototal) #Tempo total do programa